#ifndef LEGACY_REQUIRES_RETURN_TYPE_HPP
#define LEGACY_REQUIRES_RETURN_TYPE_HPP


#include <legacy_requires/promote_args.hpp>
#include <legacy_requires/base_type.hpp>
