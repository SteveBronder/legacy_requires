#ifndef LEGACY_REQUIRES_REQUIRE_HELPERS_HPP
#define LEGACY_REQUIRES_REQUIRE_HELPERS_HPP
 ...
 */
#define LEGACY_REQUIRE_ADD_REQUIRE_UNARY(check_type, checker, doxygen_group)       \
 ...
 * @param doxygen_group The doxygen group to add this requires to.
 */
#define LEGACY_REQUIRE_ADD_REQUIRE_UNARY_INNER(check_type, checker, doxygen_group)       \
  /*! \ingroup doxygen_group */                                                \
  /*! \addtogroup check_type##_types */                                        \
  /*! @{ */                                                                    \
 ...
 * @param doxygen_group The doxygen group to add this requires to.
 */
#define LEGACY_REQUIRE_ADD_REQUIRE_BINARY(check_type, checker, doxygen_group)          \
  /*! \ingroup doxygen_group */                                              \
  /*! \defgroup check_type##_types check_type  */                            \
  /*! \addtogroup check_type##_types */                                      \
  /*! @{ */                                                                  \
 ...
 * @param doxygen_group The doxygen group to add this requires to.
 */
#define LEGACY_REQUIRE_ADD_REQUIRE_BINARY_INNER(check_type, checker, doxygen_group)      \
  /*! \ingroup doxygen_group */                                                \
  /*! \addtogroup check_type##_types */                                        \
  /*! @{ */                                                                    \
 ...
 * @param doxygen_group The doxygen group to add this requires to.
 */
#define LEGACY_REQUIRE_ADD_REQUIRE_CONTAINER(check_type, checker, doxygen_group)         \
  /*! \ingroup doxygen_group */                                                \
  /*! \defgroup check_type##_types check_type  */                              \
  /*! \addtogroup check_type##_types */                                        \
  /*! @{ */                                                                    \
