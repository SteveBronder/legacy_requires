#ifndef LEGACY_REQUIRES_IS_VECTOR_HPP
#define LEGACY_REQUIRES_IS_VECTOR_HPP
...
#ifdef LEGACY_REQUIRES_EIGEN_REQUIRES
 ...
 */
template <typename T, bool = bool_constant<is_eigen<T>::value>::value>
...
LEGACY_REQUIRE_ADD_REQUIRE_UNARY(eigen_col_vector, is_eigen_col_vector,
                       require_eigens_types);
LEGACY_REQUIRE_ADD_REQUIRE_CONTAINER(eigen_col_vector, is_eigen_col_vector,
                           require_eigens_types);
...
LEGACY_REQUIRE_ADD_REQUIRE_UNARY(col_vector, is_col_vector, require_eigens_types);
LEGACY_REQUIRE_ADD_REQUIRE_CONTAINER(col_vector, is_col_vector, require_eigens_types);
...
LEGACY_REQUIRE_ADD_REQUIRE_UNARY(eigen_row_vector, is_eigen_row_vector,
                       require_eigens_types);
LEGACY_REQUIRE_ADD_REQUIRE_CONTAINER(eigen_row_vector, is_eigen_row_vector,
                           require_eigens_types);
...
LEGACY_REQUIRE_ADD_REQUIRE_UNARY(row_vector, is_row_vector, require_eigens_types);
LEGACY_REQUIRE_ADD_REQUIRE_CONTAINER(row_vector, is_row_vector, require_eigens_types);
...
LEGACY_REQUIRE_ADD_REQUIRE_UNARY(eigen_vector, is_eigen_vector, require_eigens_types);
LEGACY_REQUIRE_ADD_REQUIRE_CONTAINER(eigen_vector, is_eigen_vector, require_eigens_types);
...
LEGACY_REQUIRE_ADD_REQUIRE_UNARY(vector, is_vector, require_std);
LEGACY_REQUIRE_ADD_REQUIRE_CONTAINER(vector, is_vector, require_std);
...
LEGACY_REQUIRE_ADD_REQUIRE_UNARY(std_vector, is_std_vector, require_std);
LEGACY_REQUIRE_ADD_REQUIRE_CONTAINER(std_vector, is_std_vector, require_std);
